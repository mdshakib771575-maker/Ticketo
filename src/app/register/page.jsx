...
import {
    Card,
    CardHeader,       // ✅ CardContent না, CardBody
    Button,
    Input,
    Select,
    Form,
    ...
    SelectPopover,
    ListBox,
    ListBoxItem,      // ✅ ListBox/ListBoxItem না
} from "@heroui/react";
            ...
            <div className="gap-4">
                <Form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        {/* Select এর জায়গায় Controller ব্যবহার করুন */}
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <select
                                ...
                                className="w-full bg-slate-900/50 border-white/10 hover:border-pink-500/50 focus-within:!border-pink-500 rounded-xl p-2"
                            >
