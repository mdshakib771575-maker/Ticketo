          ...
          <div className="min-h-screen py-16 px-6 max-w-11/12 mx-auto w-full space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2 space-y-10">
                    ...
                    {/* Organizer Info */}
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-white">Organized by- <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-pink-500/30 bg-pink-500/5 text-pink-400 text-xs font-semibold uppercase tracking-wider">{event?.organizerEmail}</span> </h2>
                    </div>
                </div>
